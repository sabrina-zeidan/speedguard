...
class Speedguard {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Speedguard_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-speedguard-loader.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'admin/class-speedguard-admin.php';
		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		// require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-speedguard-public.php';

		$this->loader = new Speedguard_Loader();
	}
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'script_loader_tag', $plugin_admin, 'speedguard_tests_module_inline_fix', PHP_INT_MAX, 2 );
	}
	 ...
	 *
	 * @since     1.0.0
	 * @return    Speedguard_Loader    Orchestrates the hooks of the plugin.
	 */
