...
jQuery(document).ready(function($){
	...
	$("span.speedguard-score").each(function() {        
	 ...
	 //  $('span.speedguard-score').data('score') > 0.7 ? $(this).children('span').addClass('score-green') : ($(this).data('score') > 0.4 ? $(this).children('span').addClass('score-yellow') : $(this).children('span').addClass('score-red'))  ;
